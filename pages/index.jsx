      ...
      <main className="bg-white dark:bg-gray-900 px-10 md:px-20 lg:px-40 min-h-screen">
        ...
        <div className="text-center p-10 py-10">
          ...
          <p className="font-mono text-md pt-2 pb-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
            My expertise includes leveraging modern frameworks like Flutter, Next JS, Laravel and Node.js to develop scalable and efficient solutions. Combining my knowledge of front-end design principles with robust back-end architecture and mobile development, I create seamless user experiences across platforms. I am passionate about coding and always eager to learn new technologies and improve my skills.
          </p>
